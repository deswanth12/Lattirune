...
namespace Lattirune.Reactions
{
    ...
    /// Event-driven, data-driven, and independent from rendering systems.
    /// </summary>
    public class ElementalReactionSystem : MonoBehaviour
    {
        ...
        /// <summary>
        /// Recalculates all beam intersections and updates active elemental reactions.
        /// </summary>
        public void UpdateReactions(IReadOnlyList<(RuneData rune, Vector2Int origin, RuneConduitResult conduit)> activeConduits)
        {
            EnsureDefaultDefinitions();

            List<BeamIntersection> intersections = ElementalIntersectionEngine.FindIntersections(activeConduits);
