...
namespace Lattirune.UI
{
    ...
    {
        // ----------------------------------------------------------------------
        // Color Palette (Dark Fantasy Mobile Roguelite)
        // ----------------------------------------------------------------------
        public static readonly Color ColorObsidianBg     = new Color(0.04f, 0.05f, 0.08f, 0.96f);
        public static readonly Color ColorSurfaceDark     = new Color(0.09f, 0.11f, 0.16f, 0.98f);
        public static readonly Color ColorSurfaceHeader   = new Color(0.06f, 0.08f, 0.12f, 1.00f);
        public static readonly Color ColorSurfaceCard     = new Color(0.12f, 0.15f, 0.22f, 0.95f);
        public static readonly Color ColorBorderGold     = new Color(0.85f, 0.68f, 0.22f, 0.80f);
        public static readonly Color ColorBorderMuted    = new Color(0.25f, 0.30f, 0.40f, 0.60f);

        public static readonly Color ColorGoldPrimary    = new Color(0.96f, 0.80f, 0.22f, 1.00f);
        public static readonly Color ColorGoldAccent     = new Color(0.80f, 0.62f, 0.15f, 1.00f);
        public static readonly Color ColorCyanArcane     = new Color(0.20f, 0.85f, 0.95f, 1.00f);
        public static readonly Color ColorPurpleRune     = new Color(0.65f, 0.35f, 0.95f, 1.00f);
        public static readonly Color ColorRedDanger      = new Color(0.92f, 0.25f, 0.30f, 1.00f);
        public static readonly Color ColorGreenHealth    = new Color(0.22f, 0.82f, 0.45f, 1.00f);

        public static readonly Color ColorTextPrimary    = new Color(0.95f, 0.96f, 0.98f, 1.00f);
        public static readonly Color ColorTextMuted      = new Color(0.65f, 0.68f, 0.75f, 1.00f);
        public static readonly Color ColorTextGold       = new Color(1.00f, 0.86f, 0.35f, 1.00f);
        ...
        {
            if (_initialized && _texObsidian != null) return;
            ...
            _texBtnPrimary = CreateGradientTexture(new Color(0.85f, 0.65f, 0.15f), new Color(0.65f, 0.48f, 0.08f), 64);
            _texBtnPrimaryHover = CreateGradientTexture(new Color(0.95f, 0.75f, 0.22f), new Color(0.75f, 0.55f, 0.12f), 64);
            _texBtnSecondary = CreateGradientTexture(new Color(0.14f, 0.18f, 0.28f), new Color(0.09f, 0.12f, 0.20f), 64);
            _texBtnSecondaryHover = CreateGradientTexture(new Color(0.20f, 0.26f, 0.38f), new Color(0.13f, 0.17f, 0.26f), 64);
            _texBtnDanger = CreateGradientTexture(new Color(0.75f, 0.18f, 0.22f), new Color(0.55f, 0.10f, 0.14f), 64);
            _texBtnDisabled = CreateSolidTexture(new Color(0.15f, 0.16f, 0.20f, 0.60f));

            _texProgressBarBg = CreateSolidTexture(new Color(0.06f, 0.08f, 0.12f, 0.90f));
            _texProgressBarFillHp = CreateGradientTexture(new Color(0.25f, 0.85f, 0.45f), new Color(0.15f, 0.65f, 0.32f), 32);
            _texProgressBarFillShield = CreateGradientTexture(new Color(0.25f, 0.75f, 0.95f), new Color(0.15f, 0.55f, 0.78f), 32);
            _texBadgeBg = CreateSolidTexture(new Color(0.15f, 0.18f, 0.28f, 0.90f));
            ...
            _styleSectionTitle.normal.textColor = ColorCyanArcane;
            ...
            _stylePrimaryBtn.normal.textColor = Color.white;
        ...
        public static void DrawModalWindow(Rect windowRect, string title, string subtitle = null)
        {
            ...
            GUI.Box(new Rect(windowRect.x - 2, windowRect.y - 2, windowRect.width + 4, 3), GUIContent.none, _styleWindow);
            GUI.Box(new Rect(windowRect.x - 2, windowRect.y + windowRect.height - 1, windowRect.width + 4, 3), GUIContent.none, _styleWindow);
            GUI.color = oldColor;
        }
